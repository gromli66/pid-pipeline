...
#: Стили подписей, КОТОРЫЕ УХОДЯТ В ФАЙЛ (решение Максима 2026-08-25 №3:
#: кегль фиксированный, 18 для всех видов подписи выгрузки).
...
#: Границы охвата: у скиновой KKS-подписи семейство и начертание атрибутами
#: не задаются вовсе — в файл уходит только кегль. ⛔ **Подписи диаметра здесь
#: НЕТ и быть не должно** (решение Максима по доработке mefx-3): в FXML она не
