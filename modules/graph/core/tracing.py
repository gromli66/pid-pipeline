...
# концом, её откат сжёг бы навсегда. Порог 20 был занижен: текст, попавший в
# маску трубы, даёт шпоры по 25-35 px, они рвали трубу на куски и требовали
# ручной сшивки. При 50 вертикаль на 26747a10 снова собирается одним ребром,
# а девять узлов, снятых оператором, не появляются вовсе.
SPUR_LENGTH = 50
