...
# больше чем на 30 px.
_CHAIN_TOL = 40.0
# ⚠ Плоский порог съедает и короткие настоящие колена (5df8dea9: колено
# 37x66 px с отклонением 32 схлопнулось, оператор ставил узел руками).
# Относительный допуск (tol = 20% хорды) это чинил, но по корпусу добавлял
# ~20 лишних bendconn на чистых схемах — решением заказчика 2026-08-25
# («если больше шума — не критично») откатен: редкое колено дешевле
# дорисовать, чем искать лишние узлы.
